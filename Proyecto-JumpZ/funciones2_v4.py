...
def cargar_salto(carpeta,ventana,app,volver,config,menuprincipal,boton_temas_configuracion,boton):
    ...
    boton_casa_mainmenu_cs = crear_button(box_mainmenu_options_cs,image=cambiartemas.botones[5],command=lambda:[crear_log('Se pulsó el boton: home_mainmenu_cs','INFO'),efectos('Archivos/Audios/Sonidos/click.mp3'),cambiar_ventanas(True,menuprincipal,ventana),activar_desactivar_boton(boton_temas_configuracion,True),cambiar_boton_volver_config(boton,True,menuprincipal,config)],grid=[6,21])
    boton_volver_mainmenu_cs = crear_button(box_mainmenu_options_cs,image=cambiartemas.botones[6],command=lambda:[crear_log('Se pulsó el boton: volver_mainmenu_cs','INFO'),efectos('Archivos/Audios/Sonidos/click.mp3'),cambiar_ventanas(True,volver,ventana),activar_desactivar_boton(boton_temas_configuracion,True),cambiar_boton_volver_config(boton,True,volver,config)],grid=[12,21])
    boton_cerrar_mainmenu_cs = crear_button(box_mainmenu_options_cs,image=cambiartemas.botones[7],command=lambda:[crear_log('Se pulsó el boton: cerrar_mainmenu_cs','INFO'),efectos('Archivos/Audios/Sonidos/click.mp3'),cerrar(app),activar_desactivar_boton(boton_temas_configuracion,True)],grid=[19,21])
